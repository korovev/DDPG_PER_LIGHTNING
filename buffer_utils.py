...
Experience_weight_idx = namedtuple(
    "Experience_weight_id",
    field_names=["state", "action", "reward", "done", "new_state", "weight", "idx"],
)

"""
All the code below this comment should be type-hinted and tidied, not doing it 
for now because it should work as is. 
"""  # FIXME
